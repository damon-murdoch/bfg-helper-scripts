...
if __name__ == "__main__":
    ...
    for file_name in files:
        ...
        output = [
            "# File Auto-Generated By pokeemerald-expansion-helper-scripts (get_multi_select_from_json.py)",
