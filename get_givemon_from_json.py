...
DEFAULT_POKEBALL = "ITEM_POKEBALL"
...
if __name__ == "__main__":
    ...
    output = [
        "# File Auto-Generated By bfg-helper-scripts (get_givemon_from_json.py)",
    ...
    for file_name in files:
        ...
        with open(file_path, "r") as file:
            ...
            for pokemon in content:
                ...
                # Species
                args.append(common.get_species_constant(species))
                ...
                if "ability" in pokemon:
                    ...
                    if found == False:
                        raise Exception(f"Invalid ability for species: '{ability}'!")
                else:
