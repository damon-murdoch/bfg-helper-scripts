...
MULTI_FORM_MEGAS = ['SPECIES_CHARIZARD_MEGA_X','SPECIES_CHARIZARD_MEGA_Y','SPECIES_MEWTWO_MEGA_X','SPECIES_MEWTWO_MEGA_Y']
        ...
        with open(file_path, "r") as file:
            ...
            for pokemon in content:
                ...
                if species_id in POKEMON:
                    ...
                    raise Exception(
                        f"Data for species '{species}' ({species_id}) not found!"
                    )
                ...
                if species_constant.endswith('_MEGA') or species_constant in MULTI_FORM_MEGAS:
                    ...
                    print(f"Warning: Converting forme {species_constant} to base forme {new_constant} ...")
                ...
                if "ability" in pokemon:
                    ...
                    if found == False:
                        print(f"Warning: Invalid ability for species: '{ability}', using default ability ...")
                ...
                output.append(f"givemon({','.join(args)})")
